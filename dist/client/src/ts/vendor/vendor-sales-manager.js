...
async function generateReport() {
    try {
        ...
        const salesResponse = await apiAxios(`/vendor/sales?${params.toString()}`, { method: 'GET' });
...
function renderDailyStats(salesTotal, earnings) {
...
function clearFilters() {
    ...
    if (filterInventoryIdInput)
        filterInventoryIdInput.value = '';
}
...
//# sourceMappingURL=vendor-sales-manager.js.map