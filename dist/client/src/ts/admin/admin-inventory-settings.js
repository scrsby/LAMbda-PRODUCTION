...
inventoryForm?.addEventListener('submit', async (event) => {
    ...
    const vendorIdValue = document.getElementById('vendor-id')?.value.trim();
...
* RETURNS - void
*/
async function addItem(itemName, vendorId, inventoryCode, price, quantity) {
...
//# sourceMappingURL=admin-inventory-settings.js.map